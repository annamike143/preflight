...
## Version: Draft V2.A-Batch-1
## Status: Foundational Sections Locked
## Scope of This Batch: Section 0 — Document Control; Section 1 — Project Constitution
...
### CONST-023 — Windows and macOS Only
The MVP supports Windows and macOS only.
...
The product MAY claim support for Windows and macOS only.
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-2
## Status: Foundational Semantic Layer Locked
## Scope of This Batch: Section 2 — Executive Product Snapshot; Section 3 — Glossary and Canonical Terminology
...
### TERM-007 — App
**App** means the installed desktop application as experienced by the user on Windows or macOS.
...
- uses an allowed file type
- is within file size limits
- yields extractable text
- meets minimum text-length requirements
- passes English-language validation

### TERM-024 — Non-English Seed Document
**Non-English Seed Document** means any uploaded document whose detected language is not English or whose English-confidence score fails the required threshold.
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-3
## Status: Product Scope and User Flow Layer Locked
## Scope of This Batch: Section 4 — Product Scope and User Outcomes; Section 5 — User Journeys and Behavioral Narratives
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-4A
## Status: Product Behavior Core — Part 1 Locked
## Scope of This Batch: Section 6 — Product Behavior Specification (Part 1)
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-4B
## Status: Product Behavior Core — Part 2 Locked
## Scope of This Batch: Section 6 — Product Behavior Specification (Part 2)
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-5A
## Status: State Machine Layer — Part 1 Locked
## Scope of This Batch: Section 7 — State Machines (Part 1)
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-5B
## Status: State Machine Layer — Part 2 Locked
## Scope of This Batch: Section 7 — State Machines (Part 2)
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-6
## Status: Architecture and Data Governance Layer Locked
## Scope of This Batch: Section 8 — System Architecture; Section 9 — Data Lifecycle and Storage Policy
...
The heavy runtime package may be hydrated after install through the approved cloud distribution path.
...
Runtime distribution support must remain architecturally separate from run execution logic.
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-7
## Status: Interface and Commercial Backend Layer Locked
## Scope of This Batch: Section 10 — API and Interface Contract; Section 11 — Database and Commercial Backend Contract
...
The interface must enforce the approved supported file types for MVP.

### API-077 — File Size Enforcement Rule
The interface must enforce the approved maximum file size for MVP rather than allowing arbitrarily large seed documents into normal run flow.
...
The interface must allow Preflight to return explicit non-English rejection rather than forcing a generic upload failure.
...
- integrity-verifiable update retrieval
...
For update support flows, the backend must provide sufficient trusted metadata for the app updater to apply its verification rules.
...
The commercial backend may authorize runtime download access, but this does not make it the owner of local runtime installation.

### DB-066 — Distribution Access Rule
Runtime-distribution authorization should be tied to legitimate app entitlement/use policy where appropriate.

### DB-067 — Update Metadata Trust Rule
The commercial backend or its approved support surface must provide trustworthy update metadata consistent with the updater lifecycle rules.
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-8
## Status: UI/UX and Non-Functional Constraint Layer Locked
## Scope of This Batch: Section 12 — UI/UX Contract; Section 13 — Non-Functional Requirements
...
The MVP must support Windows and macOS only.

### NFR-006 — Unsupported Platform Rule
Linux and other platforms are out of scope for MVP and must not be treated as implied support targets.
...
The product must accept only the approved file types for seed-document intake in MVP.

### NFR-030 — File Size Enforcement Rule
The product must enforce the approved maximum file size for seed documents.

### NFR-031 — English-Only Enforcement Rule
The product must reject non-English seed documents during Preflight.

### NFR-032 — Minimum Usable Content Rule
The product must require a minimum usable amount of extractable text before approving execution.
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-9
## Status: Verification and Risk Boundary Layer Locked
## Scope of This Batch: Section 14 — Acceptance Criteria; Section 15 — Red-Team Risks and Known Weaknesses
...
### AC-006 — Windows and macOS Scope
The product MUST support Windows and macOS only for MVP.

### AC-007 — No Linux Support Claim
The product MUST NOT require Linux support for MVP completion and MUST NOT present Linux as a supported MVP platform.
...
The product MUST enforce the approved supported file-type boundary for seed-document intake in MVP.

### AC-033 — File Size Enforcement
The product MUST enforce the approved maximum file-size boundary for seed-document intake in MVP.
...
Preflight MUST reject non-English seed documents.
...
# DOCUMENT A — MASTER PROJECT CREATIVE BRIEF
## Version: Draft V2.A-Batch-10
## Status: Governance Tail Layer Locked
## Scope of This Batch: Section 16 — Implementation Guardrails for AI Coding Agents; Section 17 — Open Questions and Deferred Decisions; Section 18 — Change Log
...
### DEFER-025 — Update Delivery Packaging Question
What exact updater packaging strategy yields the best balance between simplicity, artifact size, and trust verification?
...
### DEFER-032 — Windows/macOS Scope Locked
Windows and macOS only is locked for MVP.
