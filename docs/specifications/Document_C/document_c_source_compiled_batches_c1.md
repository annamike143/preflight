...
- **Document B — Master Execution Plan, Version B1.0-Final-Draft-2**
...
- runtime hydration trigger shape
- runtime/update status retrieval shape
- artifact availability signals where applicable
- verification-related status fields where upstream documents require them
